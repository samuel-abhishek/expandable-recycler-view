package com.anshul.expandablelistview.expand;
...
public class ExpandAbilitySlice extends AbilitySlice {
    ...
    public void onStart(Intent intent) {
        ...
        tooglebtn = (Button) findComponentById(ResourceTable.Id_toogle);
        initViews(rootView);
    }
    ...
    private void initViews(ComponentContainer rootView) {
        ...
        myGroupContainer = (ExpandableListContainer) rootView.findComponentById(ResourceTable.Id_lcGroupItems_expand);
            ...
            protected void bind(ViewHolder holder, String text, Integer image, int position) {
                if (!myTempChildNameItem.contains(text)) {
                    ...
                    holder.setText(ResourceTable.Id_tvGroupTitle, text, Color.GRAY,
                            ResUtil.getIntDimen(ExpandAbilitySlice.this, ResourceTable.Float_text_20fp));
                    holder.setGroupImage(ResourceTable.Id_ivGroupIcon, image,
                            ShapeElement.RECTANGLE, Image.ScaleMode.STRETCH, ResourceTable.Color_back_white);
                    ...
                    holder.setText(ResourceTable.Id_tvGroupTitle, text, Color.GRAY,
                            ResUtil.getIntDimen(ExpandAbilitySlice.this, ResourceTable.Float_text_15fp));
                }
            }
        };
